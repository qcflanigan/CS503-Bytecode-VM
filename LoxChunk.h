#ifndef lox_LoxChunk_h
#define lox_LoxChunk_h

#include "common.h"
#include "LoxValue.h"

//the type of instructions we will see within the bytes of opcode 
typedef enum {
  OP_CONSTANT,
  OP_NIL,
  OP_TRUE,
...
//functions to declare and set chunks of byte code instructions
